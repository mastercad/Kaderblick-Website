...
/** @template-extends ServiceEntityRepository<UserTeamSupporterAssignment> */
class UserTeamSupporterAssignmentRepository extends ServiceEntityRepository
{
    public function __construct(ManagerRegistry $registry)
    {
        parent::__construct($registry, UserTeamSupporterAssignment::class);
    }

    public function userSupportsTeam(User $user, Team $team, ?DateTimeInterface $date = null): bool
    {
    ...
    /** @return UserTeamSupporterAssignment[] */
