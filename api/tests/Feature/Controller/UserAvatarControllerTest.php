...
class UserAvatarControllerTest extends ApiWebTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        // Create a minimal valid 1x1 PNG so the upload controller can process the file.
    ...
    public function testUploadAvatarResetsUseGoogleAvatarFlag(): void
    {
        ...
        $this->em->clear();
        $updatedUser = $this->em->getRepository(User::class)->findOneBy(['email' => 'user9@example.com']);
        $this->assertFalse(
