...
describe('navItemIconMap', () => {
  const expectedKeys = ['home', 'dashboard', 'my-team', 'mein-verein', 'calendar', 'games', 'reports', 'news', 'surveys', 'mein-feedback', 'tasks', 'mein-spieltag', 'spielbetrieb', 'team', 'wissenspool', 'community', 'quick-event-konfigurationen', 'hall-of-fame', 'kassenbuch', 'mein-deckel', 'strafenkatalog', 'inventar'];
