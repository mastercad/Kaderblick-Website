            ...
            {game.permissions?.can_edit_timing ? (
              ...
              >
                <Box sx={{
                  ...
                  <TextField
                    ...
                    slotProps={{
                      htmlInput: { min: 1, max: 90, 'data-testid': 'input-halfDuration' }
                    }}
                  />
                  <TextField
                    ...
                    helperText="z.B. 15"
                    slotProps={{
                      htmlInput: { min: 0, max: 60, 'data-testid': 'input-halftimeBreakDuration' }
                    }}
                  />
                  <TextField
                    ...
                    slotProps={{
                      htmlInput: { min: 0, max: 30, 'data-testid': 'input-firstHalfExtraTime' }
                    }}
                  />
                  <TextField
                    ...
                    helperText="leer = nicht erfasst"
                    slotProps={{
                      htmlInput: { min: 0, max: 30, 'data-testid': 'input-secondHalfExtraTime' }
                    }}
                  />
                </Box>
              ...
              <Box sx={{ display: 'flex', flexWrap: 'wrap', gap: 2 }}>
                <Box>
                  ...
                  }}>Halbzeitdauer</Typography>
                  <Typography variant="body2" sx={{
                    fontWeight: 600
                  }}>{game.halfDuration ?? 45} min</Typography>
                </Box>
                <Box>
                  <Typography variant="caption" sx={{
                    color: "text.secondary"
                  }}>Halbzeitpause</Typography>
                  <Typography variant="body2" sx={{
                    fontWeight: 600
                  }}>{game.halftimeBreakDuration ?? 15} min</Typography>
                </Box>
                {game.firstHalfExtraTime != null && (
                  <Box>
                    <Typography variant="caption" sx={{
                      color: "text.secondary"
                    }}>Nachspielzeit HZ1</Typography>
                    <Typography variant="body2" sx={{
                      fontWeight: 600
                    }}>{game.firstHalfExtraTime} min</Typography>
                  </Box>
                )}
                {game.secondHalfExtraTime != null && (
                  <Box>
                    <Typography variant="caption" sx={{
                      color: "text.secondary"
                    }}>Nachspielzeit HZ2</Typography>
                    <Typography variant="body2" sx={{
                      fontWeight: 600
                    }}>{game.secondHalfExtraTime} min</Typography>
                  </Box>
                )}
              </Box>
            )}
