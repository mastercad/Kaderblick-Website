...
export const NEWS_TEMPLATES: NewsTemplate[] = [
  ...
  },
  {
    ...
    icon: '📸',
    color: '#6a1b9a',
    html: `<h1>🆕 Was ist neu – [Version / Datum]</h1><p>Kurze Einleitung: Was waren die Schwerpunkte dieses Updates? Was freut uns besonders?</p><h2>✨ Das Highlight</h2><p>Beschreibt das wichtigste neue Feature in einem Absatz. Was kann es? Warum ist es ein echter Mehrwert?</p><blockquote><p>📸 <strong>Screenshot hier einfügen</strong> – zeigt, wie das Feature konkret aussieht. Empfehlung: Größe <strong>Groß (80 %)</strong>.</p></blockquote><h2>⚡ Weitere Verbesserungen</h2><ul><li><p><strong>Verbesserung 1</strong> – Kurze Beschreibung</p></li><li><p><strong>Verbesserung 2</strong> – Kurze Beschreibung</p></li></ul><blockquote><p>📸 <strong>Weiteres Bild einfügen</strong> – optional, z. B. Vorher/Nachher. Empfehlung: Größe <strong>Mittel (55 %)</strong>.</p></blockquote><h2>🐛 Bugfixes</h2><ul><li><p>Fehler beim … wurde behoben</p></li><li><p>Problem mit … ist nun gelöst</p></li></ul><blockquote><p>Habt ihr Feedback oder Ideen? Schreibt uns über die <strong>Feedback-Funktion</strong> in der App! 💬</p></blockquote>`,
  },
];
